...
fetch('https://api.giphy.com/v1/gifs/search?q=hilarious&rating=g&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My').then(res => {
    return res.json();
}).then(res => {
    console.log(res)
}).catch(err => {
...
fetch('https://api.giphy.com/v1/gifs/search?q=sun&limit=10&offset=2&api_key=hpvZycW22qCjn5cRM1xtWB8NKq4dQ2My').then(res => {
    return res.json();
}).then(res => {
    console.log(res)
}).catch(err => {
